...
const int servoPinMagnet = 7;    // Servo for magnet gripper
...
// Servos
Servo servoAir, servoVacuum, servoMagnet;
...
void setup() {
  ...
  servoMagnet.attach(servoPinMagnet);
...
void handleCNCControls() {
    ...
    if (buttonState1 == HIGH) {
        stepperZ.move(-stepsPerRevolutionZ/8); // Move Z-axis up
    } else if (buttonState2 == HIGH) {
        stepperZ.move(stepsPerRevolutionZ/8); // Move Z-axis down
    }
